...
abstract class WatcherDaemonController extends DaemonController
{
     ...
     * Job processing body
     *
     * @param array $job string name of daemon controller in yii2 router annotation
     * @return bool
     ...
     * [
     *  ['daemon' => 'one-daemon', 'enabled' => true, 'hardKill' => false]
     *  ...
     *  ['daemon' => 'another-daemon', 'enabled' => false, 'hardKill' => true]
     * ]
     * @return array
     */
